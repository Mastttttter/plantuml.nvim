...
require('plantuml').setup({
  ...
  -- منفذ الخادم لمعاينة المتصفح (الافتراضي: 8912)
  server_port = 8912,
  
  -- DPI لتصدير PNG عبر Inkscape (الافتراضي: 800)
  png_dpi = 800,
})
```
...
| `server_port` | رقم | `8912` | منفذ خادم المعاينة المحلي |
| `png_dpi` | رقم | `800` | دقة DPI لتصدير PNG |
