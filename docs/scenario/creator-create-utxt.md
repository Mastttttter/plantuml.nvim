# Scenario: create_utxt Function

- Given: A PlantUML buffer is open and PlantUML is available
- When: `create_utxt()` is called
- Then: UTXT file is generated in `umlout/utxt/` and user receives success notification with output path

## Test Steps

- Case 1 (happy path): Buffer with valid PlantUML content, UTXT generated successfully
